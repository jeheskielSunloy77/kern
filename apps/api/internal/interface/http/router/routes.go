...
func registerRoutes(
	...
	authGroup.Post("/google/mobile", h.Auth.GoogleMobile())
	...
	library.Get("/books/:id/bookmarks", h.Library.ListBookmarks())
	library.Post("/books/:id/bookmarks", h.Library.CreateBookmark())
	library.Patch("/bookmarks/:bookmarkId", h.Library.UpdateBookmark())
	library.Delete("/bookmarks/:bookmarkId", h.Library.DeleteBookmark())
	library.Get("/books/:id/notes", h.Library.ListNotes())
	library.Post("/books/:id/notes", h.Library.CreateNote())
	library.Patch("/notes/:noteId", h.Library.UpdateNote())
	library.Delete("/notes/:noteId", h.Library.DeleteNote())

	community := protected.Group("/community")
	community.Get("/books", h.Community.ListBooks())
	community.Get("/books/:id", h.Community.GetBook())
	community.Post("/books/:id/save", h.Community.SaveBook())
}
